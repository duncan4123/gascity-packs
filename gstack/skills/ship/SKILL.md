...
preamble-tier: 4
version: 1.0.0
description: "Ship workflow: detect + merge base branch, use focused verification only when needed, review diff, bump VERSION, update CHANGELOG, commit, push, create PR. (gstack)"
allowed-tools:
  - Bash
  - Read
  - Write
