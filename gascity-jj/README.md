...
Import it with the `gascity-jj` binding:

```toml
[imports.gascity-jj]
source = "../gascity-packs/gascity-jj"
```

Run the skills manually in order:

```text
Use skill gascity-jj.plan
Use skill gascity-jj.design
Use skill gascity-jj.decompose
```
